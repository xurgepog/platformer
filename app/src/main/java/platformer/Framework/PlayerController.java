...
public class PlayerController {
    ...
    public void createPlayer(float xSpawn, float ySpawn) {
    ...
    public void update(float deltaTime) {
        ...
        PVector vel = player.getVel();
        String imageRef = player.getImageRef();
        ...
        // apply forces
        if (vel.y < terminalVel) vel.y += gravity;
        ...
        player.update(deltaTime); // maybe have a centralised updater later
